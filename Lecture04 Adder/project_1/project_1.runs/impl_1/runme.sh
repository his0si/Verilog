...
HD_PWD='C:/Users/cse/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab04.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab04.tcl -notrace
