...
HD_PWD='C:/Users/cse/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab04.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab04.tcl
